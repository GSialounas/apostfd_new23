...
difference coefficients $\{U^n_j\}$ satisfying
\begin{equation}
  \label{eq:quadrecon}
\begin{split}
...
\\
\partial_t \widehat U(x_j, t^n) &= \frac{U^{n+1/2}_{j}-U^{n-1/2}_{j}}{\tau}
\end{split}
\end{equation}
\tristan{I changed this to be CNCS, is it correct?}
