function var_out = fn_plot_FTBS_burger_L2L1_bound_comparison_offset(scheme_str, init_conds,t_0)
...
for i = 1 : length(scheme_arr)
    c{i}=struct2cell(load([scheme_str,'_cell_arr_file_',init_conds,'_burger_l1l2_bound_comparison.mat']));
end
...
%     saveas(figgy,['/Users/gs1511/Desktop/GSialounas_PhD_Thesis_repo/figures/fig_SSP3WENO3_preshock',init_conds,'_plots_1x5_burgers'],'png');%char(Scheme_string)
    print(gcf,['/Users/gs1511/Desktop/apostfd_new23/figures/fig_',scheme_str,'_bound_comparison_burgers_offset_',num2str(10*t_0),'_',init_conds],'-dpng','-r600')
