...
% 
hat_fun_minLx_x = zeros(size(x));
hat_fun_plLx_x = zeros(size(x));
...
hat_fun_minLx_x(((x_minLx<=cntr) & (x_minLx>x_kmin))) = (1)/h_kmin;
hat_fun_minLx_x(((x_minLx>cntr) & (x_minLx<x_kpl))) = (-1)/h_kpl;

hat_fun_plLx_x(((x_plLx<=cntr) & (x_plLx>x_kmin))) = (1)/h_kmin;
hat_fun_plLx_x(((x_plLx>cntr) & (x_plLx<x_kpl))) = (-1)/h_kpl;
