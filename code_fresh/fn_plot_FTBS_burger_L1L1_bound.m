function var_out = fn_plot_FTBS_burger_L1L1_bound(scheme_str, init_conds,t_0,ul,ur)
...
for i = 1 : length(scheme_arr)
    c{i}=struct2cell(load([scheme_str,'_cell_arr_file_',init_conds,'_burger_try_interp.mat']));
end
...
n_plots = 4;
f_size= 14;
y_lim_error_L1 = [ 1e-3,1e-1];
y_lim_error_L2 = [1e-3,1e-1];
y_lim_EOC = [0,1.1];
ylim_EI = [0,2]
%% plots
i_int=1;
for i_scheme = 1:n_schemes
    ...
    for i_ref = 1: l_refs
        ...
        error_arr_l1  =  c{i_scheme}{1}{i_ref}(3,:);
...
%     saveas(figgy,['/Users/gs1511/Desktop/GSialounas_PhD_Thesis_repo/figures/fig_SSP3WENO3_preshock',init_conds,'_plots_1x5_burgers'],'png');%char(Scheme_string)
    ...
    print(gcf,['/Users/gs1511/Desktop/apostfd_new23/figures/fig_',scheme_str,'_bound_comparison_burgers_offset_',num2str(10*t_0),'_',condition,'_simpleinterp'],'-dpng','-r600')
    saveas(figgy,['/Users/gs1511/Desktop/apostfd_new23/figures/fig_',scheme_str,'_bound_comparison_burgers_offset_',num2str(10*t_0),'_',condition,'_simpleinterp_low_res'],'png');%char(Scheme_string)
