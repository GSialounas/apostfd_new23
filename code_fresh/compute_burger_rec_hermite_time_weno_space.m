...
%     u_t_ex = ones(size(u_ex));
    ...
    fU_burger_ex = flux(u_ex);
    [~,fUx_ex] = fn_WENO3_rec_burger_non_periodic(xiq, x,dist_x_pl, fU_burger_ex);
    IUt = fn_WENO3_rec_burger_burger_non_periodic(xiq, x,dist_x_pl, Ut_t);
