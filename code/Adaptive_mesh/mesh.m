classdef mesh <handle
    ...
    methods
        function obj = mesh(tree_list,root_ids,max_ref)
...
%             else
        ...
        function [new_grid, new_soln] = getNewVals(obj)
            new_grid = zeros(1,length(obj.elem_list_flat));
            new_soln = zeros(1,length(obj.elem_list_flat));
...
%             obj.updateMesh();
            ...
            for i = 1:ele_flat_length
                if obj.elem_list_flat(i).bound > 0.5 * max_bound
