classdef element_vector < handle
    properties
        ele_ID
    ...
    methods
        function obj = element_vector(leftEnd, rightEnd,macro_element,tol)           
            obj.leftEnd = leftEnd;
        ...
        function obj = refine(obj)
            ...
            obj1 = element_vector(x_l, x_m, obj.macro_element,tol);
            obj1.parent = obj;
            ...
            obj2 = element_vector(x_m, x_r,obj.macro_element,tol);          
            obj2.parent = obj;
