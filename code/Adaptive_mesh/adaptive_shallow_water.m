...
switch fluxfun
    ...
    case 'shallow_water'
        ...
        eig_Jf_1 = @(w) w(2,:)./w(1,:) + sq5rt(g*w(1,:));
...
%             ex_soln_hv = ex_soln(2,:);
    ...
    if (record_video)
            ...
            video = VideoWriter(['/Users/gs1511/Desktop/GSialounas_BBucket_ApostFD_repo/apostfd/videos/LxW_shw_dambreak_ic','_',num2str(maxit_arr(m)),'_solution_with_',adaptivity,'.mp4'],'MPEG-4');
            video.FrameRate = fps;
            open(video);
