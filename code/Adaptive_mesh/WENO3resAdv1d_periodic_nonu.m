function [poly_rec, poly_rec_x] = WENO3resAdv1d_periodic_nonu(xiq, x,dist_x_pl, w,flux,dflux,L_domain)
...
[nonu_ders, nonu_inds] =  fn_nonu_ders_periodic(x,v,L_domain);
B0n  = nonu_inds(1,:);
B1n = nonu_inds(2,:);
% linear weights
epsilon =1e-6;
...
[nonu_ders, nonu_inds] =  fn_nonu_ders_periodic(x,u,L_domain);
B0p  = nonu_inds(1,:);
B1p = nonu_inds(2,:);
