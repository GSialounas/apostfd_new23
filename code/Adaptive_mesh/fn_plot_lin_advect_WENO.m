function var_out = fn_plot_lin_advect_WENO(u_init,v_init, ylim_plot1, ylim_plot2, xlim_plot, EI_plot_y_lim,R_plot_lims,pow,scheme_name_str, init_conds_str, interpolant_str)
...
%         
        ...
        subplot(1,3,3)
        plot(time_arr,dofs_arr,colour_arr(end-(l_refs-i_ref)),'LineWidth',2)
...
%          print(gcf,['/Users/gs1511/Desktop/GSialounas_BBucket_ApostFD_repo/apostfd/figures/fig_',scheme_arr{i_scheme},'plots_1x5_step_IC_P3'],'-dpng','-r600')
print(gcf,['/Users/gs1511/Desktop/GSialounas_PhD_Thesis_repo/figures/fig_lin_advect_disc_L1_bound_plots_1x5_u_wave_weno_rec',init_conds,'_.png'],'-dpng','-r600')
